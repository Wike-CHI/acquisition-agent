...
> **Skill Graph：** 领域 → [[_index-outreach|多渠道触达领域]] | 上游 ← [[linkedin|LinkedIn搜索]]（找到目标后）| 下游 → [[sdr-humanizer|SDR拟人化]]（去AI味）
...
> 以下内容为红龙获客系统定制，基于公司产品线和行业知识。

### 红龙专属 Hook 公式

- "Most people think belt splicing is just about heat. After 20 years in the factory, I learned it's really about [X]."
- "We shipped a splice press to [country] last month. What happened next surprised even us:"
- "Stop buying [generic equipment]. Here's why [specific feature] matters more than you think:"
- "[Number] things I wish someone told me before buying a finger puncher:"

### 红龙内容主题库

| 主题 | Hook 示例 | 目标受众 |
|------|-----------|----------|
| 产品知识 | "Why PVC belt splicing needs precise temperature control" | 分销商/加工厂 |
| 质量对比 | "Chinese vs European splice presses: the real differences" | 采购决策人 |
| 工厂实拍 | "Behind the scenes at our HOLO factory in Wenzhou" | 建立信任 |
| 客户故事 | "How a distributor in [country] cut splicing time by 40%" | 同行分销商 |
| 行业趋势 | "The shift to automated belt fabrication in 2026" | 行业领袖 |
| 技术问答 | "Common mistakes in belt finger punching (and how to fix them)" | 技术人员 |

### 红龙产品标签（谨慎使用，3-5 个以内）

```
#BeltSplicePress #IndustrialEquipment #ConveyorBelt #Manufacturing #HOLO
```
...
**产品展示型**：
```
{Hook about a specific product feature}

We make this at HOLO (红龙) — 20 years of belt equipment manufacturing.

{Technical detail that matters}

{Why it matters for the customer's bottom line}

DM me for specs or pricing.

#BeltSplicePress #Manufacturing
```

**行业洞察型**：
```
{Contrarian or surprising observation about the belt industry}

Here's what we've seen from supplying [X] customers across [Y] countries:

{Numbered list of observations}

The best buyers aren't who you'd expect.
