...
> 红龙获客系统 v2.6.0 - 外部技能完整索引
> 更新时间：2026-04-09 10:10
> 技能总数：22个
> 文件总数：255+
...
|--------|------|----------|----------|----------|
| **smart-quote** | `smart-quote/` | 智能报价计算引擎 | 根据国家/地区、客户类型、采购量智能生成报价单 | SKILL.md, references/, scripts/ |
...
**用户说 "生成报价单"** → 调用 `smart-quote/` 技能（智能报价）或 `docx/` 技能（Word报价单）
**用户说 "给XX国客户报价"** → 调用 `smart-quote/` 技能
...
| 优先级 | 技能 | 使用频率 |
|--------|------|----------|
| ⭐⭐⭐⭐⭐ | **smart-quote**, docx, email-skill, tavily-search | 每日使用 |
