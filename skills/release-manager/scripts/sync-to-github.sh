...
RETAINED_SKILLS=(
    ...
    # 编排层
    "acquisition-coordinator" "acquisition-evaluator" "acquisition-init" "acquisition-workflow" "acquisition-dependencies"
    # 发现层
    ...
    # 社媒
    "ai-social-media-content" "holo-social-gen" "holo-social-image" "holo-social-infographic" "linkedin-writer"
    # 产品/报价
    "honglong-products" "smart-quote"
    # CRM
    "credential-manager" "crm" "customer-deduplication" "fumamx-crm" "sales-pipeline-tracker"
    # 工具层
